...
export class CountdownGriefingEscrowFactory extends SmartContract {
  static bind(address: Address): CountdownGriefingEscrowFactory {
    return new CountdownGriefingEscrowFactory(
