...
export class SimpleGriefingFactory extends SmartContract {
  static bind(address: Address): SimpleGriefingFactory {
    return new SimpleGriefingFactory("SimpleGriefingFactory", address);
  }
