...
import {
  CreateExplicitCall as CreateExplicitOneWayGriefingFactoryCall,
...
export function handleExplicitInitDataFeedFactory(
  event: ExplicitInitDataFeedFactoryEvent,
): void {
  let entity = new ExplicitInitDataFeedFactory(
...
export function handleInstanceCreatedFeedFactory(
  event: InstanceCreatedFeedFactoryEvent,
): void {
...
export function handleVariableMetadataSetFeed(
  event: VariableMetadataSetFeedEvent,
): void {
  let entity = new VariableMetadataSetFeed(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
...
export function handleStaticMetadataSetFeed(
  event: StaticMetadataSetFeedEvent,
): void {
  let entity = new StaticMetadataSetFeed(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleOperatorUpdatedFeed(
  event: OperatorUpdatedFeedEvent,
): void {
...
export function handlePostCreatedFeed(event: PostCreatedFeedEvent): void {
  let entity = new PostCreatedFeed(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleExplicitInitDataPostFactory(
  event: ExplicitInitDataPostFactoryEvent,
): void {
  let entity = new ExplicitInitDataPostFactory(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.operator = event.params.operator
...
export function handleInstanceCreatedPostFactory(
  event: InstanceCreatedPostFactoryEvent,
): void {
  let entity = new InstanceCreatedPostFactory(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.params.instance
  entity.creator = event.params.creator
...
export function handlePostCreatedPost(event: PostCreatedPostEvent): void {
  let entity = new PostCreatedPost(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.operator = event.params.operator
...
export function handleVariableMetadataSetPost(
  event: VariableMetadataSetPostEvent,
): void {
  let entity = new VariableMetadataSetPost(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.variableMetadata = event.params.variableMetadata
...
export function handleStaticMetadataSetPost(
  event: StaticMetadataSetPostEvent,
): void {
  let entity = new StaticMetadataSetPost(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.staticMetadata = event.params.staticMetadata
...
export function handleProofHashSetPost(event: ProofHashSetPostEvent): void {
  let entity = new ProofHashSetPost(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleOperatorUpdatedPost(
  event: OperatorUpdatedPostEvent,
): void {
  let entity = new OperatorUpdatedPost(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.operator = event.params.operator
...
export function handleExplicitInitDataOneWayGriefingFactory(
  event: ExplicitInitDataOneWayGriefingFactoryEvent,
): void {
  let entity = new ExplicitInitDataOneWayGriefingFactory(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
...
export function handleCreateExplicitOneWayGriefingFactory(
  call: CreateExplicitOneWayGriefingFactoryCall,
): void {
  let entity = new OneWayGriefingAgreement(call.outputs.instance.toHex())
  entity.staker = call.inputs.staker
  entity.counterparty = call.inputs.counterparty
  entity.save()
}

export function handleInstanceCreatedOneWayGriefingFactory(
  event: InstanceCreatedOneWayGriefingFactoryEvent,
): void {
  let entity = new InstanceCreatedOneWayGriefingFactory(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.params.instance
  entity.creator = event.params.creator
  ...
  let oneWayGriefing = new OneWayGriefingAgreement(
...
export function handleVariableMetadataSetOneWayGriefing(
  event: VariableMetadataSetOneWayGriefingEvent,
): void {
  let entity = new VariableMetadataSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.variableMetadata = event.params.variableMetadata
...
export function handleStaticMetadataSetOneWayGriefing(
  event: StaticMetadataSetOneWayGriefingEvent,
): void {
  let entity = new StaticMetadataSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.staticMetadata = event.params.staticMetadata
...
export function handleRatioSetOneWayGriefing(
  event: RatioSetOneWayGriefingEvent,
): void {
  let entity = new RatioSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.ratio = event.params.ratio
...
export function handleOperatorUpdatedOneWayGriefing(
  event: OperatorUpdatedOneWayGriefingEvent,
): void {
  let entity = new OperatorUpdatedOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.operator = event.params.operator
...
export function handleGriefedOneWayGriefing(
  event: GriefedOneWayGriefingEvent,
): void {
  let entity = new GriefedOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleTokenSetOneWayGriefing(
  event: TokenSetOneWayGriefingEvent,
): void {
  let entity = new TokenSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleStakeAddedOneWayGriefing(
  event: StakeAddedOneWayGriefingEvent,
): void {
  let entity = new StakeAddedOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.staker = event.params.staker
...
export function handleStakeTakenOneWayGriefing(
  event: StakeTakenOneWayGriefingEvent,
): void {
  let entity = new StakeTakenOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.staker = event.params.staker
...
export function handleStakeBurnedOneWayGriefing(
  event: StakeBurnedOneWayGriefingEvent,
): void {
  let entity = new StakeBurnedOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
  entity.staker = event.params.staker
...
export function handleLengthSetOneWayGriefing(
  event: LengthSetOneWayGriefingEvent,
): void {
  let entity = new LengthSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
...
export function handleDeadlineSetOneWayGriefing(
  event: DeadlineSetOneWayGriefingEvent,
): void {
  let entity = new DeadlineSetOneWayGriefing(
    event.transaction.hash.toHex() + '-' + event.logIndex.toString(),
  )
  entity.instance = event.address
