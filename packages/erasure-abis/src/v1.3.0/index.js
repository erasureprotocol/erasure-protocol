const Contracts = {
    NMR: {
        artifact: require('./abis/MockNMR.json').abi,
        contractObj: require('./abis/MockNMR.json'),
        bytecode : require('./abis/MockNMR.json').bytecode,
    ...
    DAI: {
        artifact: require('./abis/MockERC20.json').abi,
        contractObj: require('./abis/MockERC20.json'),
        bytecode: require('./abis/MockERC20.json').bytecode,
    ...
    Erasure_Agreements: {
        artifact: require('./abis/Erasure_Agreements.json').abi,
        contractObj: require('./abis/Erasure_Agreements.json'),
        bytecode: require('./abis/Erasure_Agreements.json').bytecode,
    ...
    Erasure_Posts: {
        artifact: require('./abis/Erasure_Posts.json').abi,
        contractObj: require('./abis/Erasure_Posts.json'),
        bytecode: require('./abis/Erasure_Posts.json').bytecode,
    ...
    Erasure_Users: {
        artifact: require('./abis/Erasure_Users.json').abi,
        contractObj: require('./abis/Erasure_Users.json'),
        bytecode: require('./abis/Erasure_Users.json').bytecode,
    ...
    Erasure_Escrows: {
        artifact: require('./abis/Erasure_Escrows.json').abi,
        contractObj: require('./abis/Erasure_Escrows.json'),
        bytecode: require('./abis/Erasure_Escrows.json').bytecode,
    ...
    FeedFactory: {
        artifact: require('./abis/Feed_Factory.json').abi,
        contractObj: require('./abis/Feed_Factory.json'),
        bytecode: require('./abis/Feed_Factory.json').bytecode,
        mainnetAddress: '',
        rinkebyAddress: '0x4b81D52e3c196B1D6D445bd99d356A86Eb98e86E',
        kovanAddress: '0x3A1a3EfeDf5C3932Bac1b637EA8Ac2D904C58480',
    },
    Feed: {
        artifact: require('./abis/Feed.json').abi,
        contractObj: require('./abis/Feed.json'),
        bytecode: require('./abis/Feed.json').bytecode,
        mainnetAddress: '',
    ...
    SimpleGriefingFactory: {
        artifact: require('./abis/SimpleGriefing_Factory.json').abi,
        contractObj:require('./abis/SimpleGriefing_Factory.json'),
        bytecode: require('./abis/SimpleGriefing_Factory.json').bytecode,
        mainnetAddress: '',
        rinkebyAddress: '0xD4817F7Ba9A518bB2abA008f0754f440529E6219',
        kovanAddress: '0xe1fE447275B02Cec4c36654E33D245Eb4a95fBE3',
    },
    SimpleGriefing: {
        artifact: require('./abis/SimpleGriefing.json').abi,
        bytecode: require('./abis/SimpleGriefing.json').bytecode,
        mainnetAddress: '',
    ...
    CountdownGriefingFactory: {
        artifact: require('./abis/CountdownGriefing_Factory.json').abi,
        bytecode: require('./abis/CountdownGriefing_Factory.json').bytecode,
        mainnetAddress: '',
        rinkebyAddress: '0xe7862De73fF5678251a6183e757AAbbe4F5AfA2C',
        kovanAddress: '0x10034DcE3D78168dc76c905EB3B3481E823DA48a',
    },
    CountdownGriefing: {
        artifact: require('./abis/CountdownGriefing.json').abi,
        contractObj: require('./abis/CountdownGriefing.json'),
        bytecode: require('./abis/CountdownGriefing.json').bytecode,
        mainnetAddress: '',
    ...
    CountdownGriefingEscrowFactory: {
        artifact: require('./abis/CountdownGriefingEscrow_Factory.json').abi,
        contractObj: require('./abis/CountdownGriefingEscrow_Factory.json'),
        bytecode: require('./abis/CountdownGriefingEscrow_Factory.json').bytecode,
        mainnetAddress: '',
        rinkebyAddress: '0x912FF45B8B3dad13E2E2EFD1414bFF811a87b548',
        kovanAddress: '0x2D1a2e0bB4a770d2257D02eCd60D730268F3dad6',
    },
    CountdownGriefingEscrow: {
        artifact: require('./abis/CountdownGriefingEscrow.json').abi,
        contractObj: require('./abis/CountdownGriefingEscrow.json'),
        bytecode: require('./abis/CountdownGriefingEscrow.json').bytecode,
        mainnetAddress: '',
