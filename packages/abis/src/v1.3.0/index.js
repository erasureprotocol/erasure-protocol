const Contracts = {
    ...
    CountdownGriefing_Factory: {
        ...
        mainnet: '0xa1811eD875E1AcE9a807aef15b885b8F616F1b0C',
        rinkeby: '0x1739C4364AE0C895EDecf083A661b64a21acA537',
        kovan: '0x580e356dF5D7e35e61d26b2f54e6C2b73625BCBe',
    },
    CountdownGriefing: {
        artifact: require('./abis/CountdownGriefing.json'),
        mainnet: '0xa7409A7D88B6A8c8A7F67929E1a8F868e2DfDEd7',
        rinkeby: '0x33C67Edb0E8beB2C8dE945De8d63329aB0dCB6bF',
        kovan: '0x490aAB8f1e8D1846553964ddcf86511C624B454e',
    },
    CountdownGriefingEscrow_Factory: {
        artifact: require('./abis/CountdownGriefingEscrow_Factory.json'),
        mainnet: '0xfdB5Dee856A2709F9D356ABb6A38c391c6eBCe6C',
        rinkeby: '0x2d96D4501143D1B4511f7C08aDEbc9A953c2F148',
        kovan: '0x59ED204258e662879884c484b23dd53cC6404Ca9',
    },
    CountdownGriefingEscrow: {
        artifact: require('./abis/CountdownGriefingEscrow.json'),
        mainnet: '0x032e5EDC2Da04c56ED87C1F3ae3dB634F1942Ec9',
        rinkeby: '0x8Dc7939be145e8092fA5950203072FE893d0ED6e',
        kovan: '0xEa50f3dfd8628CBbffD31736A2c89EBB494d8A9E',
    },
}
